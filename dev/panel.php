...
<body>
  ...
  <fluent-dialog id="owner-subuser-dialog" modal hidden data-skip-unsaved>
    <div style="padding:16px;min-width:520px;max-width:720px">
      ...
      <div style="margin-bottom:8px;color:#666;font-size:12px">实例组标识：<span class="directoryId"></span>；当前实例：<span class="configId"></span></div>
      <div style="display:flex;gap:8px;align-items:center;margin-bottom:8px;flex-wrap:nowrap">
        ...
        <fluent-text-field id="owner-subuser-pass" placeholder="子用户密码（留空随机）" type="password" class="flex-input"></fluent-text-field>
        <div id="owner-subuser-strength" class="subuser-strength"></div>
        <fluent-button appearance="accent" onclick="ownerSub_add()" style="align-self:center;flex:none;white-space:nowrap">创建子用户</fluent-button>
      </div>
      <table style="width:100%;border-collapse:collapse;table-layout:fixed">
        <thead>
          <tr>
            <th style="text-align:left;border-bottom:1px solid #ddd;padding:6px 0;width:40%">用户名</th>
            <th style="text-align:left;border-bottom:1px solid #ddd;padding:6px 0;width:40%">密码</th>
            <th style="text-align:right;border-bottom:1px solid #ddd;padding:6px 0;width:20%">操作</th>
          </tr>
        </thead>
